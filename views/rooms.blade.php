...
<section class="rooms__list">
    <div class="rooms-list-grid__container">
        <div class="rooms-list__room">
            ...
            <img class="rooms-list-room__img" src="../img/slider-rooms1.jpeg" alt="room" />
            <h3 class="rooms-list-room__h3">Minimal Duplex Room</h3>
            <p class="rooms-list-room__paraph">Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do
                eiusmod tempor.</p>
