         ...
         <div class="header__boxgeneral">
             ...
             <nav class="header-menu-desktop">
                 <ul class="header-menu-desktop-menu__items">
                     <li><a class="menu__link" href="/about_us.php">About Us</a></li>
                     <li><a class="menu__link" href="/rooms.php">Rooms</a></li>
                     <li><a class="menu__link" href="/offers.php">Offers</a></li>
                     <li><a class="menu__link" href="/contact.php">Contact</a></li>
                 </ul>
             </nav>
         </div>
