...
<section class="banner__checkdate">
    <form class="banner-checkdate__form" id="form_check_availability">
...
<section class="meet-video">
    <div class="meet-video__container">
        ...
        <button class="meet-video-container__button-dektop">BOOK NOW</button>
    </div>
    ...
    <button class="meet-video__button">BOOK NOW</button>
            ...
            <div class="swiper-slide slide-menu">
                ...
                <div class="slide-menu__container">
                    ...
                    <div class="slide-menu__food">
                        ...
                        <div class="slider-menu-food-container__description black-bg">
                            <h3 class="slider-menu-food__h3">Marmalade Selection</h3>
                            <p class="slider-menu-food__paraph">Lorem ipsum dolor sit amet, consectetur adip
                                isicing
                                elit, sed do eiusmod tempor.</p>
                            <img class="slider-menu-food-container__img-arrow" src="img/gold-arrow-icon.png" alt="arrow" />
                        </div>
                    </div>
                    <div class="slide-menu__food">
